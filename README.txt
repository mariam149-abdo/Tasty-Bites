...
- Shows old price and discounted price
...
3. Customize the text, colors, or images if needed by editing `index.html` and `style.css` using a code editor (e.g. Visual Studio Code).
